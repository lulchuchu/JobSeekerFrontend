        ...
        <>
            <div className={styles.exp}>
                <Link href = {"/company/" + companyId}>
                    <img className={styles.img} src={companyLogo} width={48} height={48}/>
                </Link>
                <div className={styles.description}>
                    <Link href = {"/company/" + companyId}>
                        <div className={styles.content}><b>{jobTitle}</b></div>
                    </Link>

                    <div className={styles.content}>{companyName} {type}</div>
                    <div className={styles.content}>{startDate} to {leaveDate}</div>
