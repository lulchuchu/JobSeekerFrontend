...
export default function Heading({token}){
    ...
    return(
        <div className={styles.heading}>
            ...
            {token ? 
                <NavBarIcon token = {token} url = "/user" component = {<img alt = "profile-icon" src = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSkqX-rwj50x1C9EP3pD_oEFvcUqHX_NHmil7sJZ90&s" width={41} height={41}></img>} name = "Profile"/> : 
