...
export default function ButtonFilter({change}){
    ...
    return (
        <div className={styles.buttonList}>
            <div>
                <button className={styles.button} onClick={handleDateButtonToogle}>
                    <p className={styles.textButton}>Date posted</p>
                </button>
                {dateButtonToogle && <div className={styles.filterButton}>
                    <ul className={styles.list} onChange={handleDateChangeRadio}>
                        <li className={styles.listItem}><input type="radio" value="1 day" checked={currentDate === "1 day"} />
                            Last 24 hours
                        </li>
                        <li className={styles.listItem}><input type="radio" value="last week" checked={currentDate === "last week"} />
                            Last week
                        </li>
            ...
            <div>
                <button className={styles.button} onClick={handleExperienceButtonToogle}>
                    <p className={styles.textButton}>Experience level</p>
                </button>
                {experienceButtonToogle && <div className={styles.filterButton}>
                    <ul className={styles.list} onChange={handleExperienceChangeRadio}>
                        <li className={styles.listItem}><input type="radio" value="Internship" checked={currentExperience==="Internship"}/>
                            Internship
                        </li>
                        <li className={styles.listItem}><input type="radio" value="Entry level" checked={currentExperience==="Entry level"}/>

                            Entry level
                        </li>
                        <li className={styles.listItem}><input type="radio" value="Mid level" checked={currentExperience==="Mid level"}/>
                            Mid level
                        </li>
                        <li className={styles.listItem}><input type="radio" value="Senior level" checked={currentExperience==="Senior level"}/>
                            Senior level
                        </li>
                    </ul>
            ...
            <div>
                <button className={styles.button} onClick={handleJobTypeButtonToogle}>
                    <p className={styles.textButton}>Job type</p>
                </button>
                {jobTypeButtonToogle && <div className={styles.filterButton}>
                    <ul className={styles.list} onChange={handleJobTypeChangeRadio}>
                        <li className={styles.listItem}><input type="radio" value="Full time" checked={currentJobType==="Full time"}/>
                            Full time
                        </li>
                        <li className={styles.listItem}><input type="radio" value="Part time" checked={currentJobType==="Part time"}/>
                            Part time
                        </li>
                        <li className={styles.listItem}><input type="radio" value="Internship" checked={currentJobType==="Internship"}/>
                            Internship
                        </li>
                    </ul>
            ...
            <div>
                <button className={styles.button} onClick={handleOnSiteButtonToogle}>
                    <p className={styles.textButton}>On-site/remote</p>
                </button>
                {onSiteButtonToogle && <div className={styles.filterButton}>
                    <ul className={styles.list} onChange={handleOnSiteChangeRadio}>
